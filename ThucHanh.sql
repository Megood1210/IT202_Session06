...
select o.order_id, o.order_date, o.status, c.customer_name from orders o join customers c on o.customer_id = c.customer_id;
...
select o.order_id, SUM(oi.quantity * oi.unit_price) as order_total from orders o
join order_items oi on o.order_id = oi.order_id
group by o.order_id;
